...
export interface DeviceDetail {
  ...
  locationLastUpdatedDate: string;
  ...
  deviceId: string;
  deviceImages: Media.MediaResource[];
  defaultDeviceImage: Core.EntityHeader;
  deviceConfiguration: Core.EntityHeader;
  deviceType: Core.EntityHeader;
  icon: string;
  customer: Core.EntityHeader;
  customerLocation: Core.EntityHeader;
  location: Core.EntityHeader;
  distributionList: Core.EntityHeader;
  notificationContacts: Users.ExternalContact[];
  offlineDistributionList: Core.EntityHeader;
  deviceURI: string;
  parentDevice: Core.EntityHeader;
  ...
  geoLocation: Core.GeoLocation;
  geoPointsBoundingBox: Core.GeoLocation[];
  hasGeoFix: boolean;
  geoFixTimeStamp: boolean;
  heading: number;
  speed: number;
  sim: string;
  customStatus: Core.EntityHeader;
  ...
  watchdogSecondsOverride: number | null;
  assignedUser: Core.EntityHeader;
  watchdogNotificationUser: Core.EntityHeader;
  debugMode: boolean;
  isBeta: boolean;
  silenceAlarms: boolean;
  silencedBy: Core.EntityHeader;
  silencedTimeStamp: string;
  diagramReference: Orgs.OrgLocationDiagramReference;
  disableGeofenceDetection: boolean;
  enableGeofenceTrackingMode: boolean;
  summary: string;
  wiFiConnectionProfile: Core.EntityHeader;
  wiFiConnectionProfileAlt: Core.EntityHeader;
  propertiesMetaData: DeviceConfiguration.CustomField[];
  propertyBag: { [key: string]: any; };
  properties: Core.AttributeValue[];
  states: Core.AttributeValue[];
  attributes: Core.AttributeValue[];
  messageValues: Core.AttributeValue[];
  inputCommandEndPoints: InputCommandEndPoint[];
  deviceGroups: Core.EntityHeader[];
  devicePin: string;
  mustChangePin: boolean;
  pinChangeDate: string;
  devicePinSecureid: string;
  internalSummary: string;
  deviceLabel: string;
  deviceIdLabel: string;
  deviceNameLabel: string;
  deviceTypeLabel: string;
  deviceOwner: Core.EntityHeader;
  geoFences: Core.GeoFence[];
  ...
  relays: Relay[];
  iPAddress: string;
  desiredConfigurationRevisionLevel: number;
  desiredConfigurationTimeStamp: string;
  actualConfigurationRevisionLevel: number;
  actualConfigurationTimeStamp: string;
  ...
  export interface DeviceTwinDetails {
    ...
    relayState_Unknown: string;
    relayState_On: string;
    relayState_Off: string;
    index: number;
    name: string;
    currentState: Core.EntityHeader;
    desiredState: Core.EntityHeader;
    lastUpdated: string;
  }
