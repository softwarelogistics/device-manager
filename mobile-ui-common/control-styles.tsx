...
export const submitButtonExternalLoginTextStyle = ViewStylesHelper.combineTextStyles([submitButtonEmailTextStyle, { color: AppServices.getAppTheme().buttonTertiaryText }]);
